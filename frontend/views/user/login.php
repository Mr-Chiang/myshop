			...
			<div class="login_form fl">
				<form action="" method="post" id="loginData">
					<ul>
						...
						<li>
							<label for="">&nbsp;</label>
							<input type="button" value="" class="login_btn" id="login"/>
						</li>
					</ul>
				</form>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#login').click(function () {
                ...
                //发起请求验证数据
                $.post('/user/login',loginData,function (data) {
//                    console.dir(data);
                    if(data.status==1){


                        setTimeout(function(){
//                            layer.msg('登录成功，两秒后跳转主页');
                            //判断上一页是否是购物车页面
                            if(document.referrer=='http://www.shop.com/goods/list'){
                                layer.msg('登录成功，两秒后跳转结算页面');
                                //跳转到结算页面
                                location.href = "/goods/settelement";
                            }else {
                                layer.msg('登录成功，两秒后跳转主页');
                                //两秒后跳转
...
//                        console.debug(data)
                    ...
                    if(data.status==2){
                            layer.tips(data.message,$('#'+data.name) , {
                                tips: [2, '#0FA6D8'],
                                tipsMore: true
                        });
                    }
            ...
            //验证码切换
            $('#changeCode,#codeImg').click(function () {
                console.debug(111);
