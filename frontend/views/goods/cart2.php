...
<body>
	...
	<div class="success w990 bc mt15">
		...
		<div class="success_bd">
            ...
            <p>
			<?php
                if(isset($orderOne->status) && $orderOne->status == 1 ){
                    echo '<img src="'.\yii\helpers\Url::to(['/goods/notify','str'=>$result->code_url]).'">';
                }
            ?>
            </p>
			<p class="message">完成支付后，你可以 <a href="/order/index">查看订单状态</a>  <a href="/index/index">继续购物</a> <a href="#">问题反馈</a></p>
		</div>
	</div>
	<!-- 主体部分 end -->
