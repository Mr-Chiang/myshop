		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					...
					<div class="smallpic">
						<a href="javascript:vpid(0);" id="backward" class="off"></a>
						<a href="javascript:vpid(0);" id="forward" class="on"></a>
						<div class="smallpic_wrap">
							<ul>
								...
								<li class="<?=$k==0?'cur':''?>">
									<a class="<?=$k==0?'zoomThumbActive':''?>" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?=$img->path.'?imageView2/2/w/350/h/350'?>',largeimage: '<?=$img['path'].'?imageView2/2/w/800/h/800'?>'}"><img src="<?=$img['path'].'?imageView2/2/w/50/h/50'?>"></a>
								</li>
                            <?php
                             endforeach;
                            ?>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li class="shop_price"><span>本店价：</span> <strong>￥<?=$goods->price?></strong> <a href="/">(降价通知)</a></li>
						<li><span>上架时间：</span><?=date('Y-m-d H:i:s',$goods->create_time)?></li>
						<li class="star"><span>商品评分：</span> <strong></strong><a href="/">(已有<?=rand(0,500)?>人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
					</ul>
					<form action="<?=\yii\helpers\Url::to(['/goods/cart','id'=>$goods->id])?>" method="post" class="choose">
						<ul>
